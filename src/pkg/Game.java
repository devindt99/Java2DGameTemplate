...
public class Game extends Canvas implements Runnable { //Canvas provides a surface to draw objects onto and runnable lets us use our game thread.
	...
	private Camera camera; //The camera follows the Player object to make sure they stay in-frame
	private SpriteSheet ss; //SpriteSheet is a collection of sprites (images) to be rendered in the program
